...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAnselFunctionLibrary_StartSession_Statics::Function_MetaDataParams[] = {
		{ "Category", "Photography" },
		{ "Comment", "/** Starts a photography session */// UObject* WorldContextObject\n" },
		{ "ModuleRelativePath", "Public/AnselFunctionLibrary.h" },
		{ "ToolTip", "Starts a photography session // UObject* WorldContextObject" },
		{ "WorldContext", "WorldContextObject" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnselFunctionLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAnselFunctionLibrary_StartSession, "StartSession" }, // 1334691032
	...
	struct Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnselFunctionLibrary, UAnselFunctionLibrary::StaticClass, TEXT("UAnselFunctionLibrary"), &Z_Registration_Info_UClass_UAnselFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnselFunctionLibrary), 487888882U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_477493739(TEXT("/Script/Ansel"),
		Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Monster_Desktop_Ansel_HostProject_Plugins_Ansel_Source_Ansel_Public_AnselFunctionLibrary_h_Statics::EnumInfo));
